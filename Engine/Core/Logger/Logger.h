...
namespace VIEngine {
	...
	public:
		static void Init();
		static VI_FORCE_INLINE std::shared_ptr<spdlog::logger> GetCoreLogger() { return sCoreLogger; }
		static VI_FORCE_INLINE std::shared_ptr<spdlog::logger> GetClientLogger() { return sClientLogger; }
	private:
